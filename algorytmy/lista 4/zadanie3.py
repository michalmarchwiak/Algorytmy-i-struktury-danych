...
tree = BinaryTree('A')
tree.set_left(BinaryTree('E'))
tree.set_right(BinaryTree('X'))
tree.left.set_left(BinaryTree('M'))
tree.left.set_right(BinaryTree('F'))
tree.right.set_left(BinaryTree('U'))
tree.right.set_right(BinaryTree('N'))
